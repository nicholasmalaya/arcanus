...
# yp, integral
# where yp and integral are multi-dimensional lists of same dimensions as allt + 1.
...
# and integral[i][j] is the pdf for the jth obs in the ith exp.
# Test values:
...
beta = []
for x_L, pdf_L, obs_L in zip(yp, integral, allh):
	beta_loc = []
...
Obs_ind = [5, 20, 35]
for beta_loc, filename, x_L, pdf_L, obs_L in zip(beta, DataFilesNames, yp, integral, allh):
