...
This proposal begins in Chapter \ref{sec:physics} with a discussion of the 
...
fidelity simulations. Chapter \ref{sec:results} details the preliminary
...
Chapter \ref{sec:proposed_work} proposes a course of investigation
