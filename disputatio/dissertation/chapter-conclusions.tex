...
Chapter \ref{sec:physics}, we will then be able to predict the
...
Chapter \ref{subsec:vane} is expected to be sufficiently general to support a
...
then be optimized similar to the examples outlined in Chapter
...
\begin{figure}[htb]
 ...
 detailed in Chapter \ref{subsec:vane} and then simulated. If the
