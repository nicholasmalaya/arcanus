...
% Required
\address{nicholas.malaya@gmail.com}
...
\input{appendix-coriolis}

%\chapter{Additional Validation Cases}
%\input{appendix-validation}

%\chapter{Mathematical Specification of Model Parameters}
%\input{appendix-params}
