...
\section{Geometry}
Horizontal and vertical views of this configuration are shown in Figures 
\ref{fig:top_design},\ref{fig:bottom_design} and
\ref{fig:vertical_design}, below. A brief summary of the differences is given below:  
