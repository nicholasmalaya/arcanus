...
\end{itemize}
 ...
 \begin{figure}[!htb]
  \begin{center}
   \includegraphics[width = 10 cm]{figs/interp_entire_top.pdf}
...
\end{itemize}
 ...
 \begin{figure}[!htb]
  \begin{center}
   \includegraphics[width = 10 cm]{figs/interp_entire_bottom.pdf}
...
The virtual vane function is now specified by a 7\textsuperscript{th} order
polynomial fitted to the boundary constraints for the vane angle within
the region of the vanes. The polynomial order was selected because it
provided a good balance between accuracy and a desire to maintain a
reasonable order. \todo{show 7th order}
...
by more than an order of magnitude.\todo{add turbine picture}
