...
largest ambient wind velocities. 
...
% direction or 15 degrees from azimuthal.  
  ...
  \begin{figure}
   ...
   author using FreeCAD\ref{Falck:2012:FH:2432428}.}  
...
Horizontal and vertical views of the new optimized configuration are
shown in Figures~\ref{fig:top_design},\ref{fig:bottom_design} and 
\ref{fig:vertical_design}, below. This design, does have some notable
...
of the 2\textsuperscript{nd} tier vanes remains six meters, 

A brief summary of the differences are provided below:     

\begin{itemize}
\item The bottom tier vanes are taller
...
prevent flow in the vanes from rising up and out of the vanes.\todo{talk
      to this} 
\end{itemize}

We now discuss each of these bullets in detail. 
...
\begin{table}[]
\centering
 \caption{The parameters used in the top tier system geometry. See
 Figure~\ref{fig:top_design} for a schematic depicting the vanes.}
\begin{tabular}{lll}
Name                        & Value & Meaning                    \\
 \hline
...
\centering
 ...
 Figure~\ref{fig:bottom_design} for a schematic depicting these vanes.}
\begin{tabular}{lll}
Name                        & Value & Meaning                    \\
 \hline
...
\begin{table}[]
 \caption{The values of parameters shown in Figure~\ref{fig:vertical_design}.}
\centering
\begin{tabular}{lll}
Name                        & Value & Meaning                    \\
 \hline
...
with FreeCAD~\ref{Falck:2012:FH:2432428} by the author and are
depicted in Figures~\ref{fig:top_down_cad} and \ref{fig:cad_skewed},
which show a top-down view of the configuration as well as a skewed
...
\begin{figure}[!htb]
  \begin{center}
   \includegraphics[width = 15 cm]{figs/top_down_cad}
...
\begin{figure}[!htb]
  \begin{center}
   \includegraphics[width = 15 cm]{figs/top_down_cad_notop}
...
\begin{figure}[!htb]
  \begin{center}
   \includegraphics[width = 15 cm]{figs/skewed_cad}
   \caption{CAD Skewed}
...
this system. However, in practice, great difficulties arise. Inverting
this system by hand is too complex and error prone, and furthermore,
...
system of equations were well-posed (a>b, for instance), but the problem
still resisted solution. 
...
The wind direction was also monitored, and showed very little variation. 
...
could easily be manipulated to align with the free stream velocity. 
 ...
 \begin{figure}[!htb]
  \begin{center}
   \includegraphics[width = 15 cm]{figs/wind_direction}
...
%It may very well be that even in the "thermal only" cases there could be
...
to 2.1 kW.\todo{add info of energy extracted} 
