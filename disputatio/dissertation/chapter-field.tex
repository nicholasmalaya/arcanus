...
constraints~\ref{thornton2004classical,bradbury1968theoretical,2015JFM...784..565S}.  
...
optimal parameters found were $\bar C_L = 1.1$ and $\bar C_D = 1.5$

the steady state power extracted by the
