...
\begin{figure}
  \centering
  \includegraphics[width=.45\linewidth]{figs/field_streamlines}
  \label{fig:field_stream}
 \caption{Fluid entrainment around the apparatus. This was drawn by
 seeding particles into the flowfield and then advancing them
...
A major uncertainty is the opacity of the device. Previous field tests
