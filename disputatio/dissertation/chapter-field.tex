...
Because the apparatus is not azimuthally symmetric, the vanes were
rotated both clockwise and counter-clockwise. A $20^{\circ}$
counter-clockwise adjustment only reduces the power by
2\%. A clockwise rotation resulted in a reduction of 8\%.
...
47\% for the counter-clockwise rotation. While substantial, this is a
``worst-case'' estimate and it was expected that the experimental team
could do better in terms of alignment than this. 
