...
In addition to the final vane design, a turbine design was developed in
...
% before duane ^ 
The peak power extracted is predicted to be 1.34 kW for the rotor
with twist, and slightly more than 1.1 kW for a rotor with no twist. 
...
in the flow power dropping by more than an order of magnitude.\todo{add
turbine flow pictures} 
...
need plot to show it is small \%\todo{finish me!}
...
semicircles, to 1.78 kW. It is interesting to note that this is 58\% of
