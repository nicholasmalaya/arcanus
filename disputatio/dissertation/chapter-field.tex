...
actuator disk models are commonly optimized\cite{790585,?,?}, the lift and
drag polars are not. Rather, a given blade geometry is assumed and then
the rotation rate, blade angle and chord length are optimized. 

Conversely, airfoil optimization is a rich field with sophisticated and
well-developed techniques\cite{?,?,?}, but these methods do not use an
actuator disk model, and focus on the shape optimization of the airfoil
geometry (and through this, the lift and drag polars).
