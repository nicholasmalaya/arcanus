...
be extracted from an idealized device.   

\section{Geometry}

The new proposed field geometry represents a significant departure from
...
Horizontal and vertical views of this new configuration are shown in
Figures  \ref{fig:top_design},\ref{fig:bottom_design} and
\ref{fig:vertical_design}, below. A brief summary of the differences are
given below:     
