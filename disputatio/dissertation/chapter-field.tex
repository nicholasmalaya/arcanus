...
the turbine should the wind heading not align with the vanes. It would
...
20^{\circ}$ and $45^{\circ}$ so that they did not align with the
freestream. This was performed by creating a new interpolation vane
function as described in Section~\ref{sec:interpolate} with a linear
...
The apparatus is therefore likely not sensitive to directional heading 
