...
the turbine should the wind heading not align with the vanes.\todo{Todd asked, "Did you do any sensistivity studies to look at variation of performance of the optimal design to the wind heading?}
 It would
be non-trivial to implement heading changes in the freestream velocity  
