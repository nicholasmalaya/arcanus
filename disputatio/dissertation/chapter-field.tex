...
to the contraction of the vanes towards the center of the SoV. The
...
Figure~\ref{} shows tracing particles advanced forward and backward in
time from the center of the device. This clearly shows that the flow is
drawn in from both the front and back of the SoV, and that the device is
entraining air from a region far larger than the SoV vane diameter. 

The optimized configuration for this case results in 4.77 kW of kinetic
energy flux through the top of the vanes, located below the turbine, which
...
Several potentially significant\todo{write me}
