...
Watts. It was observed that the peak power corresponded to periods with
the largest ambient wind velocities, which was a guideline for the
...
\begin{figure}[!htb]
  \begin{center}
   ...
   perspective on the height of the cone and first and second tiers of
   turning vanes, as well as the horizontal partitions.}
...
rotor. 
%The peak power extracted is predicted to be 1.4 kW for the rotor
