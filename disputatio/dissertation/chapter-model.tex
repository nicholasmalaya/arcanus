...
\subsection{The Governing Equations of Fluid Motion}
\label{sub_sec:ns_en}
%
...
ADD DIMENSIONS TO MAKE SCALING MORE CLEAR
%
...
Practical utility-scale wind turbines achieve at peak 75% to 80% of the Betz limit.\todo{write turbine formulation!}

turbine drag polar notes here\todo{add notes on turbine drag polar interpolation}
