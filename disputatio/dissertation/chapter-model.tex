...
vertical gradients of the velocity and temperature are,
\begin{eqnarray}
...
For this to be the case, the function $\varphi_T$ in 
Equation~\ref{eqn:eddy_kt} must have no dependence on 
$u^*$, and will approach a constant. 
Thus, scaling
