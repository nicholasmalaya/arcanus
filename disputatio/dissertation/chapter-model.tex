...
So long as the Prandtl number remains constant in space\todo{provide
discussion as to why this is not an unreasonable expectation}, then 
...
design\cite{shevell1983fundamentals,betz,?}. The essence of this model is
to approximate the individual spinning turbine blades as a washed-out
``disk'', as shown in Figure~\ref{fig:actuator_disk}.  
...
through a rotor with identical solidity butan infinite number of
blades. 
