...
effects in a broader range of flows.\todo{entire section needs another read} 
An enhanced turbulent diffusivity is used in the vortical 
plume region to account for the effects of vortex shedding from 
the trailing edge of the vanes, which is not represented in the 
...
In this equation, $U_0$ is the peak velocity, and is set based on the observed
...
no dynamics of the flow are are resolved. 
The simulations are discussed in further detail in Chapter~\ref{sec:validation}.
