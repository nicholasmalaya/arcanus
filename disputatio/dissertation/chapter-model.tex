...
approaches zero ($q \to 0$) , which is simply ``free convection''. In
this limit, the solution is expected to regain the thermally-independent
...
varying relative merits\cite{?}. However, the functions are generally in
...
\begin{figure}[p]
  \includegraphics[width=.75\linewidth]{figs/mo-compare.png}\\
  \label{fig:interp-mo}
