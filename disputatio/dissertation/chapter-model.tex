...
We use the well-known similarity model of Monin and\todo{needs another readthrough}
...
This is shown in the subfigure of Figure~\ref{fig:annealing}, where we would
