...
velocity); and the turbulent heat flux to the ground, $q$. 
...
mean turbulent quantities should be functions of only the
...
For this case, the function $\varphi_u$ must have no
