...
t = \sqrt{\frac{2 a}{z_0}}. \\
\end{eqnarray}
Combining this with, $V_f = a t$, 
\begin{equation}
V_f = \sqrt{2 a z_0}.
\end{equation}
The roughness height zero is set to the boundary layer thickness of 10
centimeters, and the acceleration was estimated at , based on the study
of surface roughness impact on tornado-like vorticies of Natarajan and
Hangan\cite{Natarajan2012577}.  
...
Dessens~\cite{dessens1972influence} and Leslie~\cite{leslie1977surface}
