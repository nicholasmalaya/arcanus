...
radial line as a function of the radial coordinate $r$. A unit normal to
vane surfaces ${\bf n}$ is defined as\todo{add theta here?}
%
\begin{equation}
...
scale with the width of the channel.\todo{add image of annealing distance}
