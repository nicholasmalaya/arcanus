...
%% \end{columns}
  ...
  \begin{block}{Monin-Obukhov Diffusivities, $\nu_{t},K_{t}$}
    ...
    \item Asymptotic conditions interpolated by functions common to atmospheric modeling
    \end{itemize}
  \end{block}
  ...
  \begin{block}{Vane Diffusivities, $\nu_{V},K_{V}$ }
    ...
    \item Set by scaling relations for a turbulent self-similar circular jet,
      \begin{equation}
        \nu_V = U_0 y_{1/2} \bar \nu_C.
      \end{equation}
    \item Set only in the region interior to the turning vanes
    \item $y_{1/2}$ set to either separation distance between vanes or system diameter
    \end{itemize}
  \end{block}
