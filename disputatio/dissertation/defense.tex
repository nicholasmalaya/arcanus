...
\begin{frame}
 ...
 picture of turbine constructed
...
\begin{block}{Possible Model Inadequacy}
\begin{itemize}
 \item Shading
       \begin{itemize}
	\item ground T inside the vane region set to the ambient air 
       \end{itemize}
 \item Back flow
 \item Poor field conditions (intermittent winds, $100^{\circ}$ F, etc.) 
\end{itemize}
\end{block}
