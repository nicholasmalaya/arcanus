...
\begin{block}{Monin-Obukhov}

\begin{itemize}
\item $\bar f = f(z,\frac{g}{T_0},u^*,\rho_0,\frac{q}{\rho_0 \, c_p})$
\item Single non-dimensional group: $ \xi = -\frac{\kappa \frac{g}{T_0} \frac{q}{c_p \rho_0} z}{ {u^*}^3}$ 
\item yar
\end{itemize}
\end{block}
