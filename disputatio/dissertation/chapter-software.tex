...
% what about chi?
To accomplish this, a mapping $\chi$ is defined that is a strictly increasing function,
with the spacing between points intially at $h_min$ and also also strictly increasing 
until the point $z_b$, where the spacing reaches a constant, $h_max$.
%
