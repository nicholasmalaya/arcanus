...
\begin{figure}[htb]
 ...
 center of the vertical velocity, consistent with
...
Figure~\ref{fig:vz-wind-vert}. The freestream velocity is traveling from
left to right at 5$ m/s$, which was set based on ambient velocity
