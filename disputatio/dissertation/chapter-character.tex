...
variation is introduced. And yet, the impact of the thermal-only case is only $\approx 100$ Watts. 
While more thermal energy will convect into the device in the cases with winds, 
this is not sufficient to account for the intensification of the vortex. 

so why does it so greatly increase the flux 

mass flux increases, in particular thorugh the back! so its more than
just wind.

this result indicates that BOTH the wind and thermal are acting in concert. 
