...
\todo{define how this is actually performed, mathematically}
 There is clearly a tight inner
...
% designs that are not robust as well as structurally infeasible.
...
The   propulsor   has   been   modelled   using 
the actuator    disc    simplification. 
Thereto,    the  propulsor  is  lumped  into  a  single  disc  with  no axial dimension.  
The  effect  of  the  propulsor  is then  obtained  by  assuming  a  uniform  pressure  difference
across  the  disc,  implicitly  given by a  momentum  balance  around  the  propulsor and the thrust
