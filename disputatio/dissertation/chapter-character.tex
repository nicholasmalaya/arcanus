...
rigid body rotation, with a linear velocity profile before the region
...
\begin{figure}[htb]
\centering
 \includegraphics[width=.9\linewidth]{figs/rankene}
...
profiles\ref{nolan1999structure}, which also have a Rankene-like
...
here, this does indicate that these simulations could be a useful tool
