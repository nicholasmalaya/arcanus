...
\end{equation}
which results in an estimate of 25 kW. This is a substantial amount of
...
years in order to generate work from solar energy. 
...
back to Roman times\cite{?}. Even Leonardo da Vinci sketched a chimney
with a turbine at the top with four vanes\cite{?}. 
...
tall chimney, with a diameter of ten meters. It collected solar resource
over 250 meters, and had a heat to work conversion efficiency of
0.2\%\cite{?}. The high cost and complexity of building structures this
tall greatly limit the feasibility of the venture. 
%
% vortex engine
%
