...
two major hypotheses attempting to explain the behavior.\todo{this paragraph needs another look}
 The first is that
...
$R_p = 3 $ m, $z_\text{max} = 3$ m, $\delta \approx 10$ cm, $g=9.81$ m/$s^2$, and a
freestream velocity of five meters per second results in an estimate of
217 Watts for the gravitational potential energy flux.\todo{the rest of this section needs another look} 

This result implies that a significant fraction of the available energy 
convecting into the the dust devil region is thus attributable to 
