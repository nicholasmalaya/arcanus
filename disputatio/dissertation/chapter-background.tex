...
study\cite{}) to generate dust devil's that possess a size
consistent\todo{fix cite} with the observed phenomenon. 
...
temperature\cite{?}.\todo{fix this} %toigo 1-12
...
greater than 1000 $W/\text{m}^2$. However, this estimate is problematic. 
...
Furthermore, Renno and Ingersoll\cite{renno_inger} used an\todo{missing}
