...
% in fact,
%
Leonardo da Vinci sketched a chimney with a turbine at the top with
four vanes\cite{}.
...
%
The resulting convection causes a hot air updraft in the tower by the
chimney effect. This airflow drives wind turbines placed in the chimney
updraft or around the chimney base to produce electricity.  


%
% typical solar updraft towers
%
For instance, Spain's Manzanares solar chimney built in the 1980's
possessed a 200 meter tall chimney, with a diameter of ten meters. It
collected solar resource over 250 meters, and had a heat to work
conversion  efficiency  of  0.2\% 

The high cost and complexity of building structures this tall greatly
limit the feasibility of the venture. 

%
% vortex engine
%
The vortex is created by admitting warm or humid air tangentially
into  the base  of  a  circular  wall. The heat source in this case has
been targeted at waste industrial heat but the thermodynamic principle
remains the same. \cite{vortex_engine,michaud2006atmospheric}
%
