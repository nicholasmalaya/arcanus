...
%
  ...
  %%   \end{center}
  %% \end{figure}
\section*{Predictions for System Sizes at Larger Kinetic Energy Milestones}

We can use our model to make some very rough predictions for system sizes to attain various power outputs. 

An interesting question is to ask if these predictions are consistent with the available experimental results. Sinclair 
