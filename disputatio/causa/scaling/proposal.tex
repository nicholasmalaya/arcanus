...
Figure \ref{fig:ke_exponent} is a first attempt at estimating the
exponent of $\alpha$. Here, we plot the kinetic energy for our available
runs on a log-log plot. 
