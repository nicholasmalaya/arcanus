...
\subsection{$\tau$ Stabilization and the operators L and S}


The operator L is simply the PDEs in Equation
\ref{eq_cont}-\ref{eq_energy} written in operator form. 

 Our objective is now to use the calculus of variations in construct the
 adjoint operator of L. This is accomplished using the Fr\'echet
 derivative, which defines the functional derivative. 
