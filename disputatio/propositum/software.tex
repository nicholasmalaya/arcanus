...
To instantiate the Navier-Stokes equations on computer, we use a
...
scaling artificially introduced to ensure that the no-slip
...
We therefore use the GRINS library\cite{GRINSpaper}, which sits on
