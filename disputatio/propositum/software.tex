...
\todo{this section could use another read}
...
\todo{also needs another read through}
%
% what about mesh...
%
...
before the refinement. The refinement halves the spacing in all three
coordinate directions, \{x,y,z\} in this region. 
...
were not sensitive to the choice of spacing. 
...
\end{equation}
 is maintained for every simulation. This ensures stability.
