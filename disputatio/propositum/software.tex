...
discretized in a consistent manner. 
The domain extents are scaled by system diameter. 
The same number of grid points are used for every
simulation. In this way the ratio of the domain length to system diameter remains
