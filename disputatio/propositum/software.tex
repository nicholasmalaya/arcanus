...
functions and integrating over the domain, $\Omega$. The result is
...
Where $(u,v) = \int_\Omega u \cdot v dx$ and $v \in H^1(\Omega)$ is an
appropriate test function in the Sobolev space of functions on
...
and $\phi = ( v,\psi,q )$, the state vector of test functions. 
...
double refinement in the region of the vanes. \todo{give
