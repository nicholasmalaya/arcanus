...
This section provides examples of the validation performed on the richest data set, 
the measurements in the laboratory. 
All of the thermal-only the data was generated in a laboratory setting at Georgia Tech. 
This general system configuration is depicted in Figure \ref{fig:lab_image}. 
These data were taken using
...
\begin{figure}[htb]
 ...
 \begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width =1.0\textwidth]{figs/sim_vs_exp_30_vt}
  \caption{Azimuthal velocity as a function of radius for the thermal-only cases.}
 \end{subfigure}%
 \begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width =1.0\textwidth]{figs/sim_vs_exp_30_vz}%
...
%%%
The simulation correctly reproduces the twin peak structure in
