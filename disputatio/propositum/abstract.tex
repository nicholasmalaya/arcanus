...
\doublespacing
 ...
 been tested against available experimental measurements, as will the
 details of the columnar vortex structure and its interaction with the
 turbine. Preliminary results from these studies will also be
 presented. In addition, we introduce the computational models being
 used to optimize the system configuration to maximize the power
 extraction. The objective of this work is to explore a wide variety of
 configurations to assess the technological feasibility of the overall
 endeavor.   
