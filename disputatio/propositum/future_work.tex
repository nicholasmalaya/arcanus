...
The three cone parameters we propose to optimize are shown in figure \ref{tab:cone}. 
...
our expectation is that the cone has to important roles. The first is acting
...
The turbine parameters to be optimized are shown in figure \ref{tab:turbine}. 
...
\todo{actual optimization and sensitivity discussion}
...
% timeline
%
A rough timeline of the proposed work is presented in table \ref{tab:prop}
...
\color{black}
\rule{\linewidth}{1pt}
%\ytl{Dec. 2015}{Validate turbine against available experimental data}
\ytb{Dec. 2015}{Algorithmic optimization subdomain problem proof-of-concept}
\ytl{Jan. 2016}{Turbine sub-domain optimization complete}
\ytl{Feb. 2016}{Cone sub-domain optimization complete}
\ytl{Feb. 2016}{Conclude Parameter sweeps through all proposed
 sub-domains}
\ytl{April 2016}{Coupling tests for parameters}
\ytb{April 2016}{Conclude Additional Parameter sweeps}
\ytl{May 2016}{Field configuration runs and predictions for
 experimental team}
\bigskip
\rule{\linewidth}{1pt}%
\end{minipage}%
