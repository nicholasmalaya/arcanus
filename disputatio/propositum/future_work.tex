...
Proposed designs for the vanes are much more abstract. Presently, the
...
\begin{figure}[htb]
 \centering
 \includegraphics[width=.75\linewidth]{figs/sketch}
 \caption{This is an example image of a proposed vane design. Sketches
 and diagrams such as this are typically generated by various members of
 the team and then simulated. If the initial results are promising, then
