...
% probably ok below:
%
The second bullet is the expected deadline to provide the results of our
...
% \end{itemize}
\todo{how does the following table look?}
\begin{center}
\begin{table}
...
\ytl{July 2016}{Validation against 2016 field data}
