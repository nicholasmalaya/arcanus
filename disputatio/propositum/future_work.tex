...
of system performance under adjustment. We are also interested
...
we will consider using this approach for the other subdomain problems. 
%
...
months, with the final optimization work on the turbine. At this time we
will proceed with ``coupling tests'' to 
...
% probably ok below:
%
We expect to provide the results of our computational
simulation efforts to the experimental group in late Spring/early Summer
of 2016 so that they can use this information in the design of the
Arizona field tests in Summer, 2016. We have proposed preparing this
information in June, but the date of the actual field test has not yet been
set. 
