...
The outflow region in the back also needs the modified neumann as
it does occasionally exhibit mild inflow on account of the unsteady wake. 
$\partial \Omega_W = \Gamma_G \bigcup \Gamma_T \bigcup \Gamma_B \bigcup \Gamma_S $. 
...
periodic is used in thermal only
