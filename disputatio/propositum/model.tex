...
single dimension-less group.\cite{munson2012fundamentals}. This is
chosen to be,
\begin{equation}
 \xi = \frac{z}{L}.
\end{equation}
...
%
\begin{equation}
 {\bf n}({\bf x}) = \sin \phi(r) \hat{{\bf r}}+ \cos\phi(r) \hat{{\bf \theta}}
\end{equation}
%
...
researchers\cite{doi:10.1146/annurev.fluid.37.061903.175743}.\todo{put this in cone section!}
