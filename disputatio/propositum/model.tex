...
This is named so because the condition is automatically satisfied on the boundary 
...
% no-traction for anything else when there's outflow, and Dirichlet v.cross.n = 0 when there's inflow.
