...
%and which intensifies greatly owing to a
%$1/r^2$ dependence. 
...
\begin{align*}
  E_p & = \int (\rho(z)-\rho_\infty) u(z) g dA. 
\end{align*}
The density only varies with height, and so the integral is simplified to only vary in 
this direction
\begin{align*}
  E_p  & = g \int^{z_\text{max}}_0 \pi R (\rho(z)-\rho_\infty) u(z) dz.
\end{align*}
Using the bousinesq approximation,
\begin{align*}
   (\rho-\rho_\infty) & = - \rho_0 \beta \Delta T \\
   (\rho-\rho_\infty) & = - \rho_0 \beta (T(z) - T_\infty),
\end{align*}
the integral is, 
\begin{align*}
  E_p & = -g  \pi R \beta \rho_0 \int^{z_\text{max}}_0 (T(z)-T_\infty) u(z) dz.
\end{align*}
...
both tiers of vanes and the wind-block cone.
  ...
  \begin{figure}[!htb]
    \begin{center}
     ...
     clearly visible. The apparatus has an outer diameter of
