...
presently understood. Regardless, these slices lend credibilty to the
...
cases has a strong thermal gradient even exterior to the device. 
To capture the difference between the ambient vertical temperature
...
effort for a thermal-only case, to detail the mode of operation
