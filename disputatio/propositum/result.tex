...
\ref{fig:thermal_vane_bottom} and \ref{fig:thermal_vane_top}.\todo{how
does this and the accompanying image look?} Note that in the
...
\caption{Horizontal drawings of the top tier vanes. These are curved 
