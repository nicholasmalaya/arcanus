...
The vertical slices are shown in figure \ref{fig:wind-ver}. Here, it can be 
clearly seen that lower tier of vanes are where the majority of flow is 
entering the center of the apparatus, while the second tier of vanes are blocking 
the ambient wind and providing protection to the vortex column. 
...
moves through the defined surface. Using the kinetic flux as a qoi, 
we have performed an optimization of the vane geometry. Over approximately 
tens of iterations, we have produced an 88X improvement in kinetic energy flux 
from the initial baseline. Several of these iterations are documented in 
figure \ref{fig:opt_plot}. Over these iterations we performed major adjustments 
to design in the the vane shape and angles, with before and after images shown in 
\ref{fig:vt-wind-vert}. During this optimization the qualitative character 
of the solution changed substantially, moving from a mild upward flow with little rotation
into a strongly organized vortex with a downward central flow and strong azimuthal velocities. 
%
%
\begin{figure}[htb!]
 \begin{subfigure}{.5\textwidth}
